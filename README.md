...
- [x] Generated Java / Kotlin / C# clients throw typed `ApiError` after retries (same policy as TS/Python/Go). Smoke prints typed-errors-ok.
- [x] Generated Rust / PHP / Swift / Ruby clients throw typed `ApiError` after retries (same policy as TS/Python/Go/Java/Kotlin/C#). Smoke prints typed-errors-ok.
