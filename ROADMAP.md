...
- [x] Generated Java / Kotlin / C# clients throw typed ApiError after retries are exhausted (same hierarchy/policy as TS/Python/Go; stdlib HttpURLConnection / HttpClient). Smoke typed-errors-ok
- [x] Generated Rust / PHP / Swift / Ruby clients throw typed ApiError after retries are exhausted (same hierarchy/policy as TS/Python/Go/Java/Kotlin/C#; stdlib-only). Smoke typed-errors-ok
